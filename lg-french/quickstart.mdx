...
<AccordionGroup>
  <Accordion icon="github" title="Date">
  ...
  <Accordion icon="rectangle-terminal" title="Numéro d'Item">
    ...
    <Accordion icon="rectangle-terminal" title="Transaction">
    ...
    <Accordion icon="rectangle-terminal" title="Prix">
